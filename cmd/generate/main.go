...
func main() {
	...
	autoUpdateTimeField := gen.FieldGORMTag("update_time", func(tag field.GormTag) field.GormTag {
		...
		gormTag["column"] = []string{"update_time"}
		gormTag["type"] = []string{"int unsigned"}
		gormTag["autoUpdateTime"] = []string{}
		return gormTag
	})
	autoCreateTimeField := gen.FieldGORMTag("update_time", func(tag field.GormTag) field.GormTag {
		gormTag := field.GormTag{}
		gormTag["column"] = []string{"update_time"}
		gormTag["type"] = []string{"int unsigned"}
		gormTag["autoCreateTime"] = []string{}
		return gormTag
	})
